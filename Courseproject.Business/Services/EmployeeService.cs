...
public class EmployeeService : IEmployeeService
{
    ...
    public EmployeeService(IGenericRepository<Employee> employeeRepository, IGenericRepository<Job> jobRepository,
        IGenericRepository<Address> addressRepository, IMapper mapper,  EmployeeUpdateValidator employeeUpdateValidator, EmployeeCreateValidator employeeCreateValidator
        )
    {
